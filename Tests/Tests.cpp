...
namespace osuCrypto
{
	...
	void programLessThan(std::array<Party, 2> parties, std::vector<iWord>& myInput1, std::vector<iWord> myInput2, BitVector& myOutput, u64 bitCount, std::vector<int> expLt)
	{
